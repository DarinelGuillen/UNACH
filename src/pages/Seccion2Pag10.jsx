            ...
            <div className="flex font-sans">
                ...
                <div className='flex flex-col w-full lg:w-5/6 bg-white rounded-tl-lg'>
                    ...
                    <div className='text-center'>
                        <p className='font-bold text-gray-500 text-base lg:text-xl'>Indicar las referencias en estilo de citación de la American Psychological Association, APA 7º edición</p>
                    </div>
                    ...
                    <div className='text-center mt-16 mb-9'>
                        ...
                        <div className='text-center mt-9'>
                            <p className='text-gray-500 text-base lg:text-xl mt-5 mb-5'>Manifiesto bajo protesta de decir verdad que esta propuesta es original y soy el autor intelectual y la inclusión de material de terceros en esta propuesta está debidamente referenciada y cuento con la autorización respecto de los derechos de Claro que la propuesta no presenta plagios parciales o totales ni controversiales legales a la vez que el desarrollo de la investigación adoptaré las medidas éticas y consideraciones legales pertinentes a sí mismo se darán los créditos a la Universidad Autónoma de Chiapas de los productos académicos que de esta propuesta emanen al participar en este proceso de registro acato los procedimientos lineamientos y políticas que la Universidad Autónoma de Chiapas establezca para tales efectos.</p>
                        </div>
