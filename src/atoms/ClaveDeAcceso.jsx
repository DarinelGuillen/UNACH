                ...
                <div className="flex w-full mt-5 justify-center">
                    <ol class="flex items-center">
                        <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-500">
                            <span class="flex items-center text-white sm:md:text-xs md:text-sm justify-center w-20 h-20 bg-gray-100 rounded-full md:h-24 md:w-24 sm:w-20 sm:h-20 lg:h-24 lg:w-24 xl:h-28 xl:w-28 dark:bg-gray-500 shrink-0">
                        ...
                        <li class="flex items-center w-full">
                            <span class="flex items-center text-white text-center sm:md:text-xs md:text-sm justify-center w-20 h-20 bg-gray-100 rounded-full md:h-24 md:w-24 sm:w-20 sm:h-20 lg:h-24 lg:w-24 xl:h-28 xl:w-28 dark:bg-gray-500 shrink-0">
