    ...
    return {
        ...
        requestOptions: {
            ...
            body: JSON.stringify({
                ...
                research_training_students                : Current.research_training_students || {},
                participating_entities                    : Current.participating_entities || {},
            }),
        },
    };
};
    ...
    return {
        ...
        requestOptions: {
            ...
            body: JSON.stringify({
                ...
                financial_breakdown                       : Current.financial_breakdown || {},
                // stages_and_activities                     : Current.stages_and_activities || null,
                committed_research_products               : Current.committed_research_products || {},
