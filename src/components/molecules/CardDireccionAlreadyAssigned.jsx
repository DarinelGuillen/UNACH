...
const CardDireccionAlreadyAssigned = ({ id, start_date, end_date, title_project, status, student_name, created_at, professor_ids}) => {
...
export default CardDireccionAlreadyAssigned;
